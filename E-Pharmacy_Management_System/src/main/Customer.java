...
// pre.execute();
	UserPojo userObj = new UserPojo(id.getText(), name.getText(), day.getSelectedItem()+"-"+month.getSelectedItem()+"-"+year.getSelectedItem(),
			address.getText(), phone.getText(), salary.getText(), password.getText());
	dao.save(userObj);
...
try{
	UserPojo userPojo = new UserPojo(id.getText(), name.getText(), day.getSelectedItem()+"-"+month.getSelectedItem()+"-"+year.getSelectedItem(),
			address.getText(), phone.getText(), salary.getText(), password.getText());
	Optional<UserPojo> userObj= dao.get(Long.parseLong(t));
	UserPojo ref = userObj.get();
    
        id.setText(ref.getId());
        
         name.setText(ref.getName());
        
             String Day = ref.getDob().split("-")[0];
             day.setSelectedItem(Day);
             String Month = ref.getDob().split("-")[1];
             month.setSelectedItem(Month);
             String Year = ref.getDob().split("-")[2];
             year.setSelectedItem(Year);
        
         String address0 = ref.getAddress();
         address.setText(address0);
        
         String phone0 = ref.getPhone();
         phone.setText(phone0);
        
         String salary0 = ref.getSalary();
         salary.setText(salary0);
         
         String pwd = ref.getPwd();
...
this.dispose();
  ...
  private void refresh(){
      try{
List<ResultSet> rs= dao.getAll();
 users.setModel(DbUtils.resultSetToTableModel(rs.get(0)));
 }catch(Exception e){
    JOptionPane.showMessageDialog(null, e.getMessage(),"Error",2);
}
  }
