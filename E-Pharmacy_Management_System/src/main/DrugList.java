...
try{
	...
	DrugPojo ref = pojo.get();
        ...
        Pharmacy.drug.name.setText(ref.getName());
        
        Pharmacy.drug.type.setSelectedItem(ref.getType());
        
        Pharmacy.drug.barcode.setText(ref.getBarcode());
        
        Pharmacy.drug.code.setText(ref.getCode());
        
        Pharmacy.drug.dose.setText(ref.getDose());
        
        Pharmacy.drug.cost_price.setText(ref.getCost_price());
        
        Pharmacy.drug.selling_price.setText(ref.getSelling_price());
        
        Pharmacy.drug.company_name.setSelectedItem(ref.getCompany_name());
        
        Pharmacy.drug.quantity.setSelectedItem(ref.getQuantity());
