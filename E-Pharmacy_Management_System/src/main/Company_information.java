 ...
 * mohsy
 */
public class Company_information extends javax.swing.JFrame {
//Connection con = null;
  ...
  try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Company_information.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Company_information().setVisible(true);
            }
        });
    }
...
private void companylist(){
     try{
    List<ResultSet> list=	 companyDao.getAll();
    ResultSet res=list.get(0);
