...
try{
	...
	drugObj.setBarcode(t);
	Optional<DrugPojo> pojo = drugDao.get(Long.parseLong(t));
	DrugPojo ref = pojo.get();
    
   
        MyPharmacy.drug.name.setText(ref.getName());
        
        MyPharmacy.drug.type.setSelectedItem(ref.getType());
        
        MyPharmacy.drug.barcode.setText(ref.getBarcode());
        
        MyPharmacy.drug.code.setText(ref.getCode());
        
        MyPharmacy.drug.dose.setText(ref.getDose());
        
        MyPharmacy.drug.cost_price.setText(ref.getCost_price());
        
        MyPharmacy.drug.selling_price.setText(ref.getSelling_price());
        
        MyPharmacy.drug.company_name.setSelectedItem(ref.getCompany_name());
        
        MyPharmacy.drug.quantity.setSelectedItem(ref.getQuantity());
        
             String Day = ref.getProduction_date().split("-")[0];
             MyPharmacy.drug.pro_day.setSelectedItem(Day);
             String Month = ref.getProduction_date().split("-")[1];
             MyPharmacy.drug.pro_month.setSelectedItem(Month);
             String Year = ref.getProduction_date().split("-")[2];
             MyPharmacy.drug.pro_year.setSelectedItem(Year);
             
              String ex_Day = ref.getExpiration_date().split("-")[0];
             MyPharmacy.drug.exp_day.setSelectedItem(ex_Day);
             String ex_Month = ref.getExpiration_date().split("-")[1];
             MyPharmacy.drug.exp_month.setSelectedItem(ex_Month);
             String ex_Year = ref.getExpiration_date().split("-")[2];
             MyPharmacy.drug.exp_year.setSelectedItem(ex_Year);
        
             String sec = ref.getPlace().split("-")[0];
             MyPharmacy.drug.section.setSelectedItem(sec);
             String pla = ref.getPlace().split("-")[1];
             MyPharmacy.drug.place.setSelectedItem(pla);
