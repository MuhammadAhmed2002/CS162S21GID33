 ...
 * @author mohsy
 */
public class Med_Buy extends javax.swing.JFrame {
Connection con = null;
...
company_name.getSelectedIndex()==0||type.getSelectedIndex()==0){
    ...
    if(check()){
      ...
      PurchasePojo purchasePojo = new PurchasePojo(barcode.getText(), name.getText(), ""+type.getSelectedItem(), ""+company_name.getSelectedItem(), ""+quantity.getSelectedItem(), cost_price.getText(), amount.getText());
    	  
        try {
        	purchaseDao.save(purchasePojo);
...
company_name.getSelectedIndex()==0||type.getSelectedIndex()==0){
    ...
    try {
    	purchaseDao.update(purchasePojo);
JOptionPane.showMessageDialog(null,"Deal has been updated Successfully","Success Operation",1);
   ...
   JOptionPane.showMessageDialog(null,e.getMessage(),"Error",2);
    ...
    private void barcodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_barcodeKeyPressed
        ...
        try{
        	PurchasePojo purchasePojo = new PurchasePojo(barcode.getText(), name.getText(), ""+type.getSelectedItem(), ""+company_name.getSelectedItem(), ""+quantity.getSelectedItem(), cost_price.getText(), amount.getText());
        	Optional<PurchasePojo> userObj =purchaseDao.get(Long.parseLong("1"));
        	PurchasePojo ref = userObj.get();
    if(ref != null){
...
if(barcode.getText().equals("")){
    ...
    if(delete==0){
    try{
    	purchaseDao.delete(purchasePojo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Med_Buy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private boolean check(){
        ...
        try{
            ...
            found=purchaseDao.isExist(purchasePojo);
