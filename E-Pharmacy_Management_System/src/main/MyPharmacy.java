...
public class MyPharmacy extends javax.swing.JFrame {
    Connection con = null;
    ...
    public MyPharmacy() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(MyPharmacy.class.getResource("/img/Untitled.png")));
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("E-Pharmacy Management");
        ...
        jLabel1.setText("E-Pharmacy Management");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Apps-session-logout-icon.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/background.jpg"))); // NOI18N
       ...
       // jPanel1.add(userB);
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/capsule.pill.health.medicine (1).jpg"))); // NOI18N
        //jPanel1.add(jLabel13);
        jLabel13.setBounds(0, 74, 1220, 520);

     //   jMenu1.setText("About MyPharmacy");
    ...
    private void purchaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_purchaseActionPerformed
        if(!username.getText().equals("Employee")){
            ...
            String sql = "select NAME,PASSWORD from users where NAME='Abdullah' ";
    ...
    private void almostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_almostActionPerformed
        new Close_To_Finish().setVisible(true);
    ...
    private void retdrugActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retdrugActionPerformed
        new RetrievalDrug().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        */
        try {
            ...
            java.util.logging.Logger.getLogger(MyPharmacy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MyPharmacy().setVisible(true);
            }
        });
    }
